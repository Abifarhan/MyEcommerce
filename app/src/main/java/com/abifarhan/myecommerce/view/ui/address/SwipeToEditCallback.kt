...
abstract class SwipeToEditCallback(context: Context) :
    ...
    private val instrinsicWidth = editIcon!!.intrinsicWidth
    ...
    override fun onChildDraw(
        ...
        if (isCanceled) {
            clearCanvas(c, itemView.left + dX,
        ...
        val editIconMargin = (itemHeight - instrinsicWidth)
        val editIconLeft = itemView.left + editIconMargin - instrinsicWidth
        val editIconRight = itemView.left + editIconMargin
        val editIconBottom = editIconTop + intrinsicHeight

        editIcon!!.setBounds(editIconLeft,
        editIconTop,
        editIconRight,
        editIconBottom)
        editIcon.draw(c)
